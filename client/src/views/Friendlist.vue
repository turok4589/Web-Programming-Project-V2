      ...
      <h2 class="title is-2">Users Page</h2>
        ...
        <div class = "columns">
            <div class = "column is-one-third">
                ...
                <div class="control">
                      <router-link to="/users"  class="button is-link is-danger"><strong>Want to add a friend? click the button to view a list of users?</strong></router-link>
                  </div>
            </div>
                      ...
                      <div class = "field" v-if="deletefriend == 1">
                        ...
                        <div class="control" v-if="deletefriend == 1">
                         <label class="label"> <strong>After you hit the add friend button hit the view friends button to look at your list of friends:</strong></label>
                          <a class="button" @click.prevent="deletefriendfromtable">
                               Delete a friend!
                          </a>
                        </div>
                      </div>
